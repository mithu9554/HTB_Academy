...
```
Saving the Results
mdmithu@htb[/htb]$ sudo nmap 10.129.2.28 -p- -oA target
...
```
Saving the Results
mdmithu@htb[/htb]$ cat target.nmap
...
```
Saving the Results
mdmithu@htb[/htb]$ cat target.gnmap
...
XML Output
  Saving the Results
mdmithu@htb[/htb]$ cat target.xml
...
```
Saving the Results
mdmithu@htb[/htb]$ xsltproc target.xml -o target.html
```
```
1
```
